...
`endif
   ...
   //RAW-12
   send_raw_data(16'h0834,2'b00,6'h2C);
   ...
   //RAW-14
   send_raw_data(16'h0834,2'b00,6'h2D);
   ...
   //RAW-12
   send_raw_data(16'h0834,2'b01,6'h2C);
   ...
   //RAW-14
   send_raw_data(16'h0834,2'b01,6'h2D);
   ...
   //RAW-12
   send_raw_data(16'h0834,2'b10,6'h2C);
   ...
   //RAW-14
   send_raw_data(16'h0834,2'b10,6'h2D);
   ...
   //RAW-12
   send_raw_data(16'h0834,2'b11,6'h2C);
   ...
   //RAW-14
   send_raw_data(16'h0834,2'b11,6'h2D);
