...
`endif
   ...
   //LINE START
   send_synch_sh_pkt(16'h000D,2'b00,6'h02);
   
   //USD - 5
   send_user_def_data(16'h01F4,2'b00,6'h34);

   //LINE END
   send_synch_sh_pkt(16'h000D,2'b00,6'h03);

   
   //LINE START
   send_synch_sh_pkt(16'h000E,2'b00,6'h02);
   
   //USD - 6
   send_user_def_data(16'h0258,2'b00,6'h35);

   //LINE END
   send_synch_sh_pkt(16'h000E,2'b00,6'h03);


   //LINE START
   send_synch_sh_pkt(16'h000F,2'b00,6'h02);
   
   //USD - 7
   send_user_def_data(16'h02BC,2'b00,6'h36);

   //LINE END
   send_synch_sh_pkt(16'h000F,2'b00,6'h03);


   //LINE START
   send_synch_sh_pkt(16'h0010,2'b00,6'h02);
   
   //USD - 8
   send_user_def_data(16'h0320,2'b00,6'h37);

   //LINE END
   send_synch_sh_pkt(16'h0010,2'b00,6'h03);



   //LINE START
   send_synch_sh_pkt(16'h0011,2'b00,6'h02);
   
   //GENERIC LONG PACKET-NULL
   send_generic_long_pkt(16'h0001,2'b00,6'h10);

   //LINE END
   send_synch_sh_pkt(16'h0011,2'b00,6'h03);


   //LINE START
   send_synch_sh_pkt(16'h0012,2'b00,6'h02);
   
   //GENERIC LONG PACKET-BLANKING
   send_generic_long_pkt(16'h0064,2'b00,6'h11);

   //LINE END
   send_synch_sh_pkt(16'h0012,2'b00,6'h03);

   
   //LINE START
   send_synch_sh_pkt(16'h0013,2'b00,6'h02);
   
   //GENERIC LONG PACKET-EMBEDDED
   send_generic_long_pkt(16'h0320,2'b00,6'h12);

   //LINE END
   send_synch_sh_pkt(16'h0013,2'b00,6'h03);
