...
`endif
  ...
  for (word_count = 30 ; word_count <= 1000 ; word_count = word_count + 30)     // 10-6-10
  ...
  begin
    ...
    send_synch_sh_pkt(16'h0001,vc[1:0],6'h00);
      ...
      begin
        ...
        //USER_DEFINED_TYPE 
        send_comp_data_usd10(word_count,vc[1:0],data_id,2'b01,3'h3); // 10-6-10 
