...
`endif
  ...
  for (word_count = 84 ; word_count <= 1000; word_count = word_count + 84)      // 12-7-12
  begin
    ...
    send_synch_sh_pkt(16'h0001,vc[1:0],6'h00);
      ...
      begin
        ...
        send_comp_data_usd12(word_count,vc[1:0],data_id,2'b01,3'h2); //  12-7-12
